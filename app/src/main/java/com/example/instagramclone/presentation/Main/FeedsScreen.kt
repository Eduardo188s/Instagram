...
import com.example.instagramclone.presentation.Profile.BottomNavigationItem
import com.example.instagramclone.presentation.Profile.BottomNavigationMenu
import com.example.instagramclone.presentation.Profile.Toast
...
fun ProfileInfoSection(it: Post) {
    Row (modifier= Modifier
        ...
        Icon(rememberImagePainter(data = it.userImage), contentDescription = "Profile Image", tint = Color.Unspecified)
