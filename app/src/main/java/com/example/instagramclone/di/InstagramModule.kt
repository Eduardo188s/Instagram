...
import com.example.instagramclone.domain.use_cases.AuthenticationUseCases.IsUseAuthenticated
...
object InstagramModule {
    ...
    fun provideAuthUseCases(repository: AuthenticationRepository)= AuthenticationUseCases(
        isUseAuthenticated = IsUseAuthenticated(repository =  repository),
